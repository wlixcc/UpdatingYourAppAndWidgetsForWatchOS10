...
public struct BirdSpeciesInfo: RawRepresentable, Hashable, CaseIterable, Codable {
    ...
    public var summary: String {
        switch self {
        case .swallow:
            String(localized: "A cutie, common to many backyards.", table: "Birds", bundle: .module, comment: "Bird 1 summary")
        case .dove:
        ...
        case .hummingbird:
            String(localized: "A frequent flier among the flowers.", table: "Birds", bundle: .module, comment: "Bird 6 summary")
        default:
            fatalError()
        }
    }
