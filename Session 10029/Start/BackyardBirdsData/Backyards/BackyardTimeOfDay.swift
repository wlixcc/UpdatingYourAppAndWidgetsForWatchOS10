...
public extension BackyardTimeOfDay {
    var title: String {
        ...
        case .sunrise: String(
            ...
            table: "Backyards",
            bundle: .module,
            comment: "A short phrase that describes the sunrise time of day for a backyard."
        )
        case .morning: String(
            localized: "Morning",
            table: "Backyards",
            bundle: .module,
            comment: "A short phrase that describes the morning time of day for a backyard."
        )
        case .afternoon: String(
            localized: "Afternoon",
            table: "Backyards",
            bundle: .module,
            comment: "A short phrase that describes the afternoon time of day for a backyard."
        )
        case .sunset: String(
            localized: "Sunset",
            table: "Backyards",
            bundle: .module,
            comment: "A short phrase that describes the sunset time of day for a backyard."
        )
        case .night: String(
            localized: "Night",
            table: "Backyards",
            bundle: .module,
            comment: "A short phrase that describes the night time of day for a backyard."
        )
        }
    }
}
