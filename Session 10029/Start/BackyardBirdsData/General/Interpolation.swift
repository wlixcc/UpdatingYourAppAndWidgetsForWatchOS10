...
public extension BinaryFloatingPoint {
    ...
    ///
    /// If this value is 175 and you pass 50 for the `truncation` value, this returns 0.5 because it's 50% toward the next `truncation` value.
    ///
    /// > Important: The value you use when calling this method needs to be a finite number.
    ...
    /// Maps a value from `originalRange` into a percentage that returns an equivalent value in `newRange`.
    ///
    /// > Important: The value you use when calling this method needs to be a finite number.
    /// - Parameters:
