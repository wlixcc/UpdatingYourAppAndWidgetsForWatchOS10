    ...
    var title: String {
        ...
        case .favoriteFood:
            String(
                ...
                table: "Birds",
                bundle: .module,
                comment: "A short phrase that describes a sort criteria based on the birds' favorite foods."
            )
        case .dislikedFoods:
            String(
                ...
                table: "Birds",
                bundle: .module,
                comment: "A short phrase that describes a sort criteria based on the birds' disliked foods."
            )
        case .favorites:
            String(
